 ...
 * All visible strings come from the active locale (t.hero).
 */
        ...
        >
          ...
          <div>
            ...
            <h1 className="hero-name fade-up fade-up-delay-1">
              <span style={{ color: "var(--text)" }}>{h.headline1}</span><br />
              <span className="hero-name-accent">{h.headline2}</span>
            </h1>
          ...
          {/* ── Right: floating avatar (hidden on tablet/mobile via CSS) ────────── */}
          <div
          ...
          >
            ...
            <span className="skill-pill">📍 {h.location}</span>
          </div>
        </div>
