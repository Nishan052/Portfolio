...
// Static fallback shown while HeroCanvas loads or on touch devices
    ...
    <div className="container">
      ...
      <div className="hero-grid">
        ...
        <div
          ...
          className="hero-avatar hero-avatar-col"
          data-parallax-speed="0.18"
        >
          <div aria-hidden="true" className="hero-avatar-canvas-wrapper">
            {isTouchDevice ? (
              <AvatarFallback />
            ) : (
