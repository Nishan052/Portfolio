 ...
 * Highlight bullets switch to highlights_de when German is active.
 */
      ...
      <div className="container">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          {experiences.map((exp, i) => {
            const highlights =
              lang === "de" && exp.highlights_de ? exp.highlights_de : exp.highlights;
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    {/* Bullet highlights — German when lang === 'de' and highlights_de exists */}
